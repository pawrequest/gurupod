...
#
#
# async def names_n_links_as(page_url: str):
...
#     new_eps = []
#     async for tup in names_n_links_as(page_url):
...
#     episodes = []
#     async with aiohttp.ClientSession() as session:
#         pages = await get_listing_pages_as(main_url)
#         for page in pages:
...
#
#
# async def get_listing_pages_as(main_url: str) -> List[str]:
#     num_pages = _get_num_pages_as(main_url)
...
from gurupod.episode_sync import ep_soup_date, ep_soup_links, ep_soup_notes
